...
$ helm repo update
$ helm search repo appscode/stash-catalog --version=v2025.9.26
$ helm upgrade -i stash-catalog appscode/stash-catalog -n kube-system --create-namespace --version=v2025.9.26
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n kube-system --create-namespace --version=v2025.9.26 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n kube-system --create-namespace --version=v2025.9.26 --values values.yaml
```
