...
$ helm repo update
$ helm search repo ak8sdb/stash-catalog --version=v2023.03.16
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2023.03.16
```
...
```bash
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2023.03.16 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2023.03.16 --values values.yaml
```
