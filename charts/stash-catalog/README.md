...
$ helm repo update
$ helm search repo ak8sdb/stash-catalog --version=v2022.03.30
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2022.03.30
```
...
```bash
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2022.03.30 --set image.registry=stashed
```
...
```bash
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2022.03.30 --values values.yaml
```
