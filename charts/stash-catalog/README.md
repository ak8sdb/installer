...
$ helm repo update
$ helm search repo ak8sdb/stash-catalog --version=v2025.3.17
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2025.3.17
```
...
```bash
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2025.3.17 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2025.3.17 --values values.yaml
```
