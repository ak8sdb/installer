...
$ helm repo update
$ helm search repo ak8sdb/stash-catalog --version=v2024.1.9
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2024.1.9
```
...
```bash
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2024.1.9 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog ak8sdb/stash-catalog -n kube-system --create-namespace --version=v2024.1.9 --values values.yaml
```
