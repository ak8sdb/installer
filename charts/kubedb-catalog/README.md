...
$ helm repo update
$ helm search repo ak8sdb/kubedb-catalog --version=v2023.03.16
$ helm upgrade -i kubedb-catalog ak8sdb/kubedb-catalog -n kubedb --create-namespace --version=v2023.03.16
```
...
```bash
$ helm upgrade -i kubedb-catalog ak8sdb/kubedb-catalog -n kubedb --create-namespace --version=v2023.03.16 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i kubedb-catalog ak8sdb/kubedb-catalog -n kubedb --create-namespace --version=v2023.03.16 --values values.yaml
```
