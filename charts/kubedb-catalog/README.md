...
$ helm repo update
$ helm search repo ak8sdb/kubedb-catalog --version=v2022.08.02
$ helm upgrade -i kubedb-catalog ak8sdb/kubedb-catalog -n kubedb --create-namespace --version=v2022.08.02
```
...
```bash
$ helm upgrade -i kubedb-catalog ak8sdb/kubedb-catalog -n kubedb --create-namespace --version=v2022.08.02 --set -- generate from values file --
```
...
```bash
$ helm upgrade -i kubedb-catalog ak8sdb/kubedb-catalog -n kubedb --create-namespace --version=v2022.08.02 --values values.yaml
```
