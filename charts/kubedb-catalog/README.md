...
$ helm repo update
$ helm search repo ak8sdb/kubedb-catalog --version=v2025.5.9
$ helm upgrade -i kubedb-catalog ak8sdb/kubedb-catalog -n kubedb --create-namespace --version=v2025.5.9
```
...
```bash
$ helm upgrade -i kubedb-catalog ak8sdb/kubedb-catalog -n kubedb --create-namespace --version=v2025.5.9 --set proxies.ghcr=ghcr.io
```
...
```bash
$ helm upgrade -i kubedb-catalog ak8sdb/kubedb-catalog -n kubedb --create-namespace --version=v2025.5.9 --values values.yaml
```
