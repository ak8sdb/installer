...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2025.9.26
$ helm upgrade -i kubedb appscode/kubedb -n kube-system --create-namespace --version=v2025.9.26
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kube-system --create-namespace --version=v2025.9.26 --set kubedb-community.operator.registry=ghcr.io/ak8sdb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kube-system --create-namespace --version=v2025.9.26 --values values.yaml
```
