...
$ helm repo update
$ helm search repo ak8sdb/kubedb --version=v2022.05.13
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2022.05.13
```
...
```bash
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2022.05.13 --set kubedb-community.operator.registry=ghcr.io/ak8sdb
```
...
```bash
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2022.05.13 --values values.yaml
```
