...
$ helm repo update
$ helm search repo ak8sdb/kubedb --version=v2025.5.9
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2025.5.9
```
...
```bash
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2025.5.9 --set kubedb-community.operator.registry=ghcr.io/ak8sdb
```
...
```bash
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2025.5.9 --values values.yaml
```
