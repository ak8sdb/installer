...
$ helm repo update
$ helm search repo ak8sdb/kubedb --version=v2022.08.26
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2022.08.26
```
...
```bash
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2022.08.26 --set kubedb-community.operator.registry=ghcr.io/ak8sdb
```
...
```bash
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2022.08.26 --values values.yaml
```
