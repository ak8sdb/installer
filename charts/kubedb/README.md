...
$ helm repo update
$ helm search repo ak8sdb/kubedb --version=v2023.03.16
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2023.03.16
```
...
```bash
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2023.03.16 --set kubedb-community.operator.registry=ghcr.io/ak8sdb
```
...
```bash
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2023.03.16 --values values.yaml
```
