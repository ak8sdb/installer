...
$ helm repo update
$ helm search repo ak8sdb/kubedb --version=v2022.07.07
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2022.07.07
```
...
```bash
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2022.07.07 --set kubedb-community.operator.registry=ghcr.io/ak8sdb
```
...
```bash
$ helm upgrade -i kubedb ak8sdb/kubedb -n kube-system --create-namespace --version=v2022.07.07 --values values.yaml
```
