...
$ helm repo update
$ helm search repo appscode/stash-catalog --version=v2025.12.15
$ helm upgrade -i stash-catalog appscode/stash-catalog -n kube-system --create-namespace --version=v2025.12.15
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n kube-system --create-namespace --version=v2025.12.15 --set waitTimeout=300
```
...
```bash
$ helm upgrade -i stash-catalog appscode/stash-catalog -n kube-system --create-namespace --version=v2025.12.15 --values values.yaml
```
