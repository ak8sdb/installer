...
$ helm repo update
$ helm search repo appscode/kubedb --version=v2025.12.15
$ helm upgrade -i kubedb appscode/kubedb -n kube-system --create-namespace --version=v2025.12.15
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kube-system --create-namespace --version=v2025.12.15 --set kubedb-community.operator.registry=ghcr.io/ak8sdb
```
...
```bash
$ helm upgrade -i kubedb appscode/kubedb -n kube-system --create-namespace --version=v2025.12.15 --values values.yaml
```
